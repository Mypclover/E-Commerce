...
public class AdminController {
	...
	public ModelAndView manageCategories()
	{
		...
		//Call list method here to refresh in page after update.
		mv.addObject("category", category);
		mv.addObject("categoryList",categoryDAO.list());
		//But only doing this will not show in category fields in update. SO you have to add session to save it throughout the session.
