		...
		<div class="well">
			...
			<div class="container">
				<div class="col-md-4 col-sm-12">
					<img class="img-responsive center-block" src="<c:url value="/resources/images/${selectedProduct.id}.jpg" />" alt="${selectedProduct.name}" />
				</div>
				<div class="col-md-5 col-xs-7">
					<div class="h2">${selectedProduct.name}</div>
					<div class="h3">Product description: ${selectedProduct.discription}</div>
				...
				<div class="col-md-3 col-xs-5">
						...
						<div class="h2">Rs:${selectedProduct.price}</div>
						<c:if test="${isUserLoggedIn=='true'}">
							<a href="myCart_add/${selectedProduct.id}" class="btn btn-success">
