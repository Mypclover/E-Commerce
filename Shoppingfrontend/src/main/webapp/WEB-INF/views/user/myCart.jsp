		...
		<div id="viewCart">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4">
						<td><a href="myCart_deleteAll/${cart.user_id}" class="btn btn-danger">Delete All Products</a></td>
					</div>
				</div>
			</div>
			<table class="table table-striped">
				...
				<tr>
					...
					<td><a href="myCart_checkOut/${cart.user_id}" class="btn btn-success">Check Out</a></td>
				</tr>
